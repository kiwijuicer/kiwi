...
import { runAttempt } from "../../commands/execution/attempt";
import { runCost } from "../../commands/runs/cost";
import { runEvidenceManifest } from "../../commands/execution/evidence";
import { runExplain } from "../../commands/planning/explain";
import { runFinalize } from "../../commands/execution/finalize";
import { runInit } from "../../commands/setup/init";
import { runOperatorSnapshot } from "../../commands/operations/operator";
import { runPlan } from "../../commands/planning/plan";
import { runRun } from "../../commands/runs/run";
import { runRulesSync } from "../../commands/setup/rules";
