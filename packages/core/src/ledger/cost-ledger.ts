...
export const AuditEventTypes = {
  ...
  ProviderFallbackSelected: "provider_fallback_selected",
  ...
  PlanMarkdownWritten: "plan_markdown_written",
  ...
  McpPreviewPruned: "mcp_preview_pruned",
  ...
  RunPlanUpdated: "run_plan_updated",
  ReplanStarted: "replan_started",
